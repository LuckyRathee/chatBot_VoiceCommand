     ...
     while (1):
        ...
        try:
            ...
            if 'wikipedia' in queuery:
                ...
                spacek("I have been created by Lucky")
            ...
            elif "know Shivani" in queuery:
                spacek(
                    f"yes{sex} i know her becuase of her im able to talk to you he is a very nice person would you like to know more about shivani laddha")
                s = takecommend().lower()
                if s == "yes":
                    me1()
                else:
